...
public class WebsiteBookFlow {

	WebDriver driver;
	public String baseUrl = "https://webd004.healthians.co.in";
	// String driverPath =
	// "C:\\Users\\Healthians\\Downloads\\chromedriver-win32\\chromedriver.exe";
//  String driverPath = "C:\\Users\\Healthians\\Downloads\\chromedriver-win32 (1)\\chromedriver-win32\\chromedriver.exe";

	public String getOTPFromDB(String query) {
		String dbHost = "gateway.echl.in";
		String dbPort = "10301";
		String dbName = "d10";
		String dbUser = "akshay_mankar";
		String dbPass = "uLew5RIaxrvbsF36yL6oIpvD";
		...
		try {
			...
			rs = stmt.executeQuery("Select * from user_otp where mobile_no='7030704374'");
			while (rs.next()) {
...
// Wait for a confirm dialog to appear, and then accept it
		/*
		 * WebDriverWait wait2=new WebDriverWait(driver,90); WebElement
		 * element2=wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
		 * "//*[@data-src='https://cdn4.healthians.com/img/static/gurgaon.svg']")));
...
//System.out.println("Title=Blood test in delhi ncr, whole body checkup delhi, medical test in gurgaon, health checkup in Noida, best diagnostic lab in delhi NCR");
		...
		WebElement element1 = wait1
				.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@id='mobile_number']")));
		element1.sendKeys("7030704374");
		Thread.sleep(3000);
...
//ele1.click();
		...
		String otp = getOTPFromDB("Select otp_code from user_otp where mobile_no='7030704374'");
		...
		while (Duration.between(start, Instant.now()).compareTo(timeout) < 0) {
			otp = getOTPFromDB("Select otp_code from user_otp where mobile_no='7030704374'");
...
// Verify if Kidney test is selected or not,by assertion
		driver.findElement(By.xpath("//*[@data-value='Vitamin D Total-25 Hydroxy']")).click();
		Assert.assertFalse(driver.findElement(By.xpath("//*[@data-value='Vitamin D Total-25 Hydroxy']")).isSelected());
		System.out.println(driver.findElement(By.xpath("//*[@data-value='Vitamin D Total-25 Hydroxy']")).isSelected());

		/*
		 * WebElement
		 * elem2=driver.findElement(By.xpath("//*[@data-value='Kidney Function Test']"))
		 * ; elem2.click();
		 */
		Thread.sleep(2000);
...
//Search button is clickable or not, by assertion
		...
		/*
		 * WebElement
		 * elem3=driver.findElement(By.xpath("//*[@class='button_icon_form']"));
		 * elem3.click();
		 */
		Thread.sleep(2000);
		...
		/*
	List<WebElement> allExistingMembers = driver.findElements(By.xpath("//div[@class='wrap wrap-section']//div[@id='existing_member_list']//div[@class='custmer_inf']//strong"));
	
	for (WebElement allMemberList : allExistingMembers) {
		
		if(allMemberList.getText().equalsIgnoreCase("Akshay M,")) {
			
			driver.findElement(By.xpath("//input[@onclick='addMemberWithPackage(this)']")).click();
			Thread.sleep(10000);
	...
	*/
     ...
     //Next button is clickable or not,by assertion.
		Assert.assertFalse(
				driver.findElement(By.xpath("//*[@class='btn_3 mtl_30 ga_add_memeber_next_button']")).isSelected());
		System.out.println(
				driver.findElement(By.xpath("//*[@class='btn_3 mtl_30 ga_add_memeber_next_button']")).isSelected());
		//Thread.sleep(3000);
		...
		*/
		...
		WebElement element7 = wait7.until(
				ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#pay_wrp_cash > div > label > span")));
		...
		WebElement element9 = wait9.until(ExpectedConditions.visibilityOfElementLocated(
		...
		select.selectByVisibleText("Wrong Test Booked");
